            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="dropdown nav-item">
                    <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                        ...
                        <p class="d-lg-none"> {{ __('Lang') }} </p>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-right dropdown-navbar">
                        <li class="nav-link">
                            <a href="/setlocale/ru" class="nav-item dropdown-item @if(app()->getLocale() == 'ru') active @endif">{{ __('main.Russian') }}</a>
                        </li>
                        <li class="nav-link">
                            <a href="/setlocale/en" class="nav-item dropdown-item @if(app()->getLocale() == 'en') active @endif">{{ __('main.English') }}</a>
                        </li>
                    </ul>
                </li>
                <li class="dropdown nav-item">
